...
if(!window.XMLHttpRequest) {
   ...
   //alert("hello call");
   xmlhttp.open('GET', 'Search4.php?L1=' + encodeURIComponent(document.getElementById('lati').value) + '&L2=' + encodeURIComponent(document.getElementById('long').value) , true);
...
if(!window.XMLHttpRequest) {
   ...
   xmlhttp = new XMLHttpRequest();
   //alert("hello call");
   xmlhttp.open('GET', 'Search2.php?ur=' + sStr, true);
