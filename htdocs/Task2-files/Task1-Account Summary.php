              ...
              <div class="TabbedPanelsContent"><!-- InstanceBeginEditable name="BPEdit" -->
			   <div id="breadcrumbs"> 
                  ...
                  <table width="862" border="1">
                    <tr>
                      <td height="665"><table width="855" border="0">
                        <tr>
                          <td width="351">    <p>&nbsp;</p>
                            <p>  Choose Plan    
                              <label for="planList"></label>
                              <select name="planList" size="1" id="planList" title="Select your Plan" width="200">
                                <option>Garuda 9901311271</option>
                                <option>Broadband freedom 769</option>
                                <option>All</option>
                              </select>
                            </p>
                            <p>&nbsp;</p></td>
                          <td width="358"><p size="50">Current Balance: Rs 650 <font size="2">(for chosen plan)</font></p></td>
                        </tr>
                        <tr>
                          <td><p>&nbsp;</p>
                          ...
                          <td> <p>Select Bank Account/Card 
                              <select name="cardList" size="1" id="cardList">
                                <option>Visa xxxx-xxxx-7789</option>
                              </select>
                            </p></td>
                        </tr>
                        <tr>
                          <td colspan="2"><p><img src="../../Ad4.png" width="328" height="261" align="right" /></p>
                            <p>&nbsp;</p>
                            <p>Payment For: 
                              <label>
                                <br />
                                <input type="radio" name="RadioGroup2" value="radio" id="RadioGroup2_0" />
                                Total Amount Due: Rs 650 <font size="2" color="#0000CC">   <u>Currency Conversion </u></font>
                              </label>
                              <br />
                              <label>
...
<p> <font size="2">(can make a partial payment using multiple cards/accounts) </font></p> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                               <input type="submit" name="pay" id="pay" value="Make a Payment" />
			  ...
			  <!-- InstanceEndEditable --></div>
              <div class="TabbedPanelsContent"><!-- InstanceBeginEditable name="BHEdit" --><!-- InstanceEndEditable --></div>
              ...
              <div class="TabbedPanelsContent"><!-- InstanceBeginEditable name="ProEdit" --><div id="breadcrumbs1"> 
                  ...
                  <div id="TabbedPanels6" class="VTabbedPanels">
                    ...
                    <div class="TabbedPanelsContentGroup">
                      <div class="TabbedPanelsContent" width="500" height="400"> 
                        <p>&nbsp;</p>
                        <p align="center"><strong>User Profile</strong></p>
                        <p align="center"><strong>
  <label for="profile-details"></label>
                          <textarea name="profile-details" id="profile-details" cols="45" rows="10">Name:
...
Address:
                          ...
                          <input type="submit" name="editprof" id="editprof" value="Edit Profile" />
                        </strong></p>
                      </div>
                      <div class="TabbedPanelsContent" width="500" height="400">
                        <p><strong>Payment Information Saved to your account </strong> </p>
                        <p>
                          <input type="button" name="paymode2" id="paymode2" value="Add a new payment mode" />
                        </p>
                        <p>Net Banking Accounts:</p>
                        <table width="500" border="1">
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td><div align="right"><font size="2.5" color="#000099"><u>View</u> &nbsp;&nbsp; &nbsp;&nbsp;  <u>Edit</u> &nbsp;&nbsp;&nbsp;&nbsp;   <u>Remove</u></font></div></td>
                          </tr>
                        </table>
                        <p>&nbsp;</p>
