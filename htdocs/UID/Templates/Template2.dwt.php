...
.container .content #bordertab table tr td div {
	color: #000;
	background-image: url(../images/brown.png);
}
.passwd {
...
.container .content table tr #bordertab #bordertab tr #bordertab #CollapsiblePanel1 .CollapsiblePanelContent #login_form {
	color: #FFF;
}
.container .content table tr #bordertab #bordertab tr #bordertab #CollapsiblePanel1 .CollapsiblePanelContent #login_form {
	text-align: center;
...
<body style="overflow:scroll; height:620px">
...
<br /><br />
 <a href="http://localhost:81/UID/Templates/temp2.dwt.php" class="buttonLeft"> Go to Smart Search</a>
...
<div class="container">
  ...
  <div class="content">
  <table width="909" id="bordertab">
  <tr height="100">
    <th width="201" height="100" valign="top" background="../images/brown.png" scope="col" id="bordertab"><p>&nbsp;</p>
      <p><img src="../images/MTNL-Logo.jpg" width="166" height="120" align="top" />
        <span class="hjeadingfd">Mahanagar Telephone Nigam Limited</span></p>
    </th>
...
// EndOAWidget_Instance_2141541
  ...
  <table width="907" border="0" align="center" >
   ...
   <tr align="left">
   <td width="198" align="center" background="../images/brown.png" id="bordertab">
      <h1 align="right" ><img src="../images/individual.png" width="124" height="132" align="left" /></h1>
<h1 align="right" >&nbsp;</h1>
<h1 align="right" >&nbsp;</h1>
<h1 align="right" >&nbsp;</h1>
<h1 align="right" ><strong>Individual</strong> </h1></td>
   
    <td width="438" height="292" bgcolor="#FFFFFF" id="bordertab"><br>
    <ul id="MenuBar1" class="MenuBarHorizontal">
      ...
      <table width="248" border="0" align="center" >
        <tr valign="top" bgcolor="#FFFFFF">
          <td width="306" height="212" align="left" valign="middle" ><p style="font-size: 16px"><br>
          <a href="http://localhost:81/UID/Templates/temp2.dwt.php"><img src="../images/smt.png" width="240" height="182" align="left" /></a></p></td>
          </tr>
    </table>
    <td width="257" bgcolor="#FFFFFF" id="bordertab"><table width="240" border="0"  align="center" id="bordertab">
      <tr align="right" > 
<td width="215" align="left" bgcolor="#D6D6D6" id="bordertab">
...
<form action="../login.php" method="post" id="login_form" style="font-size: x-small" />
 Username or Password Incorrect!!
  ...
  <span id="sprypassword1"><span class="passwd_field">  <span class="passwd">Password</span></span>
...
var CollapsiblePanel1 = new Spry.Widget.CollapsiblePanel("CollapsiblePanel1");
      ...
      <p>&nbsp;</p>
      <p style="color: #630">Follow us on:</p>
      <table width="256" border="0" align="center">
        <tr>
       <td width="58" height="49"><img src="../images/fb.jpg" width="43" height="38" /></td>
       <td width="54"><img src="../images/google.jpg" width="41" height="41" /></td>
       <td width="51"><img src="../images/twitter.jpg" width="44" height="47" /></td>
       <td width="75"><img src="../images/you.jpg" width="39" height="41" /></td>
        </tr>
 </table>
   ...
   <table width="904" height="244" border="0" align="center" id="bordertab">
  <tr>
  <td width="200" height="238" id="bordertab"align="left" background="../images/brown.png" rotate "><p>&nbsp;</p>
    <p><img src="../images/enterprize.png" width="126" height="110" align="left" /></span></h5>
    </p>
    
    <h1>&nbsp;</h1>
    <h1>&nbsp;</h1>
    <h1><strong>Enterprise</strong></h1></td>
    <td width="436" valign="top" bgcolor="#FFFFCC" scope="row">
      <br />
...
<td width="252">
  <img src="../images/offer8.jpg" width="252" height="236" /></td>
</tr>
</table>


  <div class="footer" id="bordertab">
  <table width="909" border="0">
    <tr>
      <td width="223" height="24"> <div align="center">About Us</div></td>
