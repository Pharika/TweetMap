        ...
        <div class="TabbedPanelsContent">
          <div id="TabbedPanels2" class="TabbedPanels">
            <ul class="TabbedPanelsTabGroup">
              ...
              <li class="TabbedPanelsTab" tabindex="0"> <a href="../Task1-Account summary.php" target="_self">Account Usage</a></li>
              <li class="TabbedPanelsTab" tabindex="0">Pay Your Bills</li>
              <li class="TabbedPanelsTab" tabindex="0">Billing History</li>
            ...
            <div class="TabbedPanelsContentGroup">
              ...
              <div class="TabbedPanelsContent"><!-- TemplateBeginEditable name="AUEdit" -->Makes Change in theAUEdit Blue coloured box ( this is editable region ) <!-- TemplateEndEditable --></div>
