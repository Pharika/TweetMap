...
function logoff()
{
	window.open("http://localhost/UID/Templates/Template1.dwt.php");
}
</script>
<style type="text/css">
<!--
...
<div class="container">
  <div class="header">
    <table width="957" border="0" background="../images/lime2.jpg" >
      <tr>
        <td width="391">
        <a href="http://localhost/UID/Templates/Template1.dwt.php"><img id="logo" src="../images/mtnl_logo.png" alt="Insert Logo Here" name="Insert_logo" width="391" height="66" id="Insert_logo" style="display:block;" /></a>
        </td>
        <td width="248" >&nbsp;</td>
        <td width="304">
...
?></font></strong>  &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
             &nbsp;&nbsp;  &nbsp;&nbsp;  &nbsp;&nbsp;
              <input id="designbutton" type="submit" name="logout" id="logout" value="Log out" onclick="logoff()"/>
            </p>
              </td>
          </tr>
        </table></td>
  ...
  <div class="content">
    <div id="TabbedPanels1" class="TabbedPanels">
      <ul class="TabbedPanelsTabGroup">
        ...
        <li class="TabbedPanelsTab" tabindex="0">Enterprise</li>
      </ul>
  ...
  <!-- end .content --></div>
  <div class="footer">
  <table width="958" border="1" background="../images/lime2.jpg">
    <tr>
