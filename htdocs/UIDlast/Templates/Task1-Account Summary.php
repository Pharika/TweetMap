...
/* BeginOAWidget_Instance_2137022: #datepicker_3 */
		...
		#datepicker_3 .ui-widget {
			font-family: inherit;
		}
			
		#datepicker_3 .ui-datepicker {
			font-family: "Trebuchet MS", Arial, Helvetica, sans-serif;
		}
		
		#datepicker_3 .ui-datepicker-title {
			font-family: "Trebuchet MS", Arial, Helvetica, sans-serif;
			font-size: 1.1em;
			color: #cc0000;
			font-weight: normal;
		...
		#datepicker_3 .ui-state-default, .ui-widget-content .ui-state-default {
			border-color: #ff9900;
			background-color: #ff9900;
			color: #cc0000;
		}
		
		#datepicker_3 .ui-state-default, .ui-state-default a {
			color: #cc0000;
		}	
		
			
		#datepicker_3 .ui-state-highlight, .ui-widget-content .ui-state-highlight {
			border-color:#66cc99;
			background-color:#66cc99;
			color:#666699;
		}		
		
		#datepicker_3 .ui-state-active, .ui-widget-content .ui-state-active { 
			border-color: #333399;
			background-color: #333399;
			color: #330066; 
		}
		
		#datepicker_3 .ui-state-hover, .ui-widget-content .ui-state-hover, .ui-state-focus, .ui-widget-content .ui-state-focus 	
		{
			border-color: #ffff99;
		...
		/* Text attributes for the Days of Week Text */ 
		#datepicker_3 .ui-datepicker table th
		{
			font-size: .8em;
			color: #cc0000;
			font-weight: bold;
...
<oa:widgets>
  ...
  <oa:widget wid="2137022" binding="#datepicker_3" />
</oa:widgets>
-->
<!--</script>-->
...
// EndOAWidget_Instance_2137022
                                            ...
                                            <div id="datepicker_3" class="ui-glass-gradient ui-80TopTo0Bottom-gradient-header"></div>                                          -->
                                            </td>
                                          </tr>
                                          <tr>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
                ...
                <p>&nbsp;</p>
              <!-- InstanceEndEditable --></div>
              <div class="TabbedPanelsContent"><!-- InstanceBeginEditable name="BPEdit" -->Makes Changes in the BPEdit Blue coloured box ( this is editable region )
