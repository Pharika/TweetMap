...
.container .content table tr td table tr td #CollapsiblePanel1 .CollapsiblePanelContent #login_form {
	color: #F00;
	font-size: x-small;
	text-align: center;
}
...
<br /><br />
 <a href="http://localhost:81/UID/Planometer1.php" class="buttonLeft"> Go to Smart Search</a>
...
<div class="container">
  ...
  <tr height="100">
    <th width="201" height="100" valign="top" bgcolor="#FFFFFF" scope="col"><p>&nbsp;</p>
    ...
    <ul id="MenuBar1" class="MenuBarHorizontal">
      ...
      <table width="312" border="0" align="center">
        <tr valign="top" bgcolor="#FFFFFF">
          <td width="306" height="171" align="left" valign="top"><p style="font-size: 16px"><br><img src="../images/smt.png" width="232" height="182" /></p></td>
          </tr>
...
<span class="incorrect">Username or Password Incorrect!</span> <span id="sprytextfield1">
...
<h1>&nbsp;</h1>
    <h1>&nbsp;</h1>
    <h1>&nbsp;</h1>
    <h1><span class="rotate"><strong>Enterprise</strong></span></h1></td>
