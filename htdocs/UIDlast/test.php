...
function ShowNextPageInTab(action) {
  if (action == 'Save') {
        ...
        <div class="TabbedPanelsContent">
          <div id="TabbedPanels2" class="TabbedPanels">
            ...
            <div class="TabbedPanelsContentGroup">
              ...
              <div id="breadcrumbs1"> 
                  <h5><a href="#"><font size="2.5">My Account</a> &gt;Profile</h5> </div>
                  ...
                  <div class="TabbedPanelsContentGroup">
                    ...
                    <div id="top">
                      ...
                      <p>
                       ...
                       <table align="center" border="0">
                         <tr> <td>
                        <div id="CardInfo" style="display:none"> <form>
                         <table border="0">
                         <tr> <td>
                      ...
                      <tr>
                        <td> <div align="right">
                          <input type="button" name="Save" id="Save" value="Save" onclick="TabbedPanels4.showPanel(0)"/> 
                          &nbsp;&nbsp;&nbsp; 
                      ...
                      <div id="BankAccInfo" style="display:none"> <form>
                      	<table border="0">
                         <tr> <td>
                        Account Holder's name*  
                        <label for="name2"></label>
                        ...
                        <input type="text" name="billaddress" id="billaddress" /></td> </tr>
                         <tr>
                        <td> <div align="right">
                          <input type="button" name="Save" id="Save" value="Save" onclick="ShowNextPageInTab(this.value)"/> 
                          &nbsp;&nbsp;&nbsp; 
                          <input type="reset" name="reset" id="reset" value="Reset" />   
                          &nbsp;&nbsp;&nbsp; 
                          <input type="submit" name="cancel" id="cancel" value="Cancel" />
