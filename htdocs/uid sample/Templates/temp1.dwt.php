        ...
        <div class="TabbedPanelsContent">
          <div id="TabbedPanels2" class="TabbedPanels">
            ...
            <div class="TabbedPanelsContentGroup">
              ...
              <div class="TabbedPanelsContent"><!-- TemplateBeginEditable name="AUEdit" -->Makes Changes in theAUEdit Blue coloured box ( this is editable region ) <!-- TemplateEndEditable --></div>
