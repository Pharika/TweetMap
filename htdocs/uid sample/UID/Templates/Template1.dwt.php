        ...
        <td>
          <div id="CollapsiblePanel1" class="CollapsiblePanel">
           <div class="CollapsiblePanelTab" tabindex="0">
             <p align="center"><input class="AccButton" type="button" value="My Account" /></p>
           </div>
           <div class="CollapsiblePanelContent">
            <form action="../Task1-Account Summary.php" method="get" name="Login">
...
<script type="text/javascript">
  ...
  <!-- end .content --></div>
  <div class="footer">
  <table width="960" height="35" border="1">
    <tr>
