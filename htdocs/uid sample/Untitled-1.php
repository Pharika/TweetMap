        ...
        <div class="TabbedPanelsContent">
          <div id="TabbedPanels2" class="TabbedPanels">
            <ul class="TabbedPanelsTabGroup">
              ...
              <li class="TabbedPanelsTab" tabindex="0">View Accounts</li>
              <li class="TabbedPanelsTab" tabindex="0">Bill Payment</li>
            ...
            <div class="TabbedPanelsContentGroup">
              ...
              <div class="TabbedPanelsContent"><!-- InstanceBeginEditable name="VAEdit" -->
              <div class="TabbedPanelsContent">
                <p>dj;fkjs;dklfj'adkljgadkljgr'ed</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p>zm,xdblvkjadf;nvkjad;fv</p>
              </div>
              <!-- InstanceEndEditable --></div>
              <div class="TabbedPanelsContent"><!-- InstanceBeginEditable name="BPEdit" -->BPEdit<!-- InstanceEndEditable --></div>
              <div class="TabbedPanelsContent"><!-- InstanceBeginEditable name="SerEdit" -->SerEdit<!-- InstanceEndEditable --></div>
              <div class="TabbedPanelsContent"><!-- InstanceBeginEditable name="ProEdit" -->ProEdit<!-- InstanceEndEditable --></div>
            </div>
          </div>
        </div>
        <div class="TabbedPanelsContent">
          <div id="TabbedPanels3" class="TabbedPanels">
            ...
            <div class="TabbedPanelsContentGroup">
              <div class="TabbedPanelsContent"><!-- InstanceBeginEditable name="MobEdit" -->MobEdit<!-- InstanceEndEditable --></div>
              <div class="TabbedPanelsContent"><!-- InstanceBeginEditable name="InterEdit" -->InterEdit<!-- InstanceEndEditable --></div>
              <div class="TabbedPanelsContent"><!-- InstanceBeginEditable name="FixedEdit" -->FixedEdit<!-- InstanceEndEditable --></div>
            </div>
          </div>
        </div>
